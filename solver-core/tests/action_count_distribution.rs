...
// player infoset on the corrected tree? If MAX_NA=4 padding wastes most
...
fn action_count_distribution_on_corrected_tree() {
    ...
    eprintln!("MAX_NA constant = {} (regret buffer pads to this per infoset)\n", MAX_NA);
    ...
    eprintln!("  Total MAX_NA slots:   {}", total_max_na_slots);
